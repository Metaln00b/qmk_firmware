...
uint16_t mouse_jiggle_move_delay = 20000;
...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [1] = LAYOUT(
        ...
        _______, _______, _______, RGB_HUI, _______, _______, _______, NK_TOGG, KC_MJT,  _______, _______, _______,          _______, RGB_MOD,  KC_HOME,
...
void matrix_scan_user(void) {
    if (mouse_jiggle_mode) {
        if (timer_elapsed(mouse_jiggle_timer) > mouse_jiggle_move_delay) {
            if (mouse_jiggle_change_direction) {
                tap_code(KC_MS_LEFT);
                mouse_jiggle_change_direction = !mouse_jiggle_change_direction;
            } else {
